...
from FedSystem.FLCore.server.serverdpfedavg import serverDPFedAvg
...
if __name__ == '__main__':
    ...
    # local_iterations
    parser.add_argument('-li', "--local_iterations", type=int, default=30,
                        help="DP-FedAvg` Q")
    ...
    # algorithm
    parser.add_argument('-algo', "--algorithm", type=str, default="DPFedAvg")
