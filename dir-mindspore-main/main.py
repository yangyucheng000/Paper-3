...
def get_args_parser():
    ...
    parser.add_argument('--lr_int_encoder', default=1e-4, type=float)
    ...
    parser.add_argument('--hoi_path', default='hico_20160224_det', type=str)
    ...
    parser.add_argument('--Guass', action='store_true')
    parser.add_argument('--gt_lr_cross', action='store_true')
    parser.add_argument('--model_name', default='Shunted_MHA', type=str)
    ...
    parser.add_argument('--scale_verb', default=1.5, type=float, help='scale_verb')
    parser.add_argument('--scale_verb_gt', default=1.5, type=float, help='scale_verb_gt')
    parser.add_argument('--scale_object', default=1.2, type=float, help='scale_obj')
    parser.add_argument('--start_layer', default=1, type=int, help='start_layer')
    parser.add_argument('--nROI_Head', default=2, type=int, help='nROI_Head')
    parser.add_argument('--shuffle', action='store_true')
    parser.add_argument('--MultiQ', action='store_true')
    return parser
