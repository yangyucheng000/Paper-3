...
Models = {'TEM-NCD-C2F-GroupInsert'};
modelNum = length(Models);

% ---- 2. Ground-truth Datasets Setting ----
DataPath ='E:/SHSF/DL/database/test_database/';
Datasets = {'CAMO_TestingDataset', 'CHAMELEON_TestingDataset','COD10K_TestingDataset'};
...
for d = 1:datasetNum
    ...
    for m = 1:modelNum
        ...
        gtFiles = dir([gtPath '*.png']);
        imgNUM = length(gtFiles);
